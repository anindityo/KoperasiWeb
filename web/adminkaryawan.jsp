...
<html lang="en">
    ...
    <body id="page-top">
        ...
        Akun ak = (Akun) new AkunController(HibernateUtil.getSessionFactory()).getById(id);
                        ...
                        <form action="../../tambahKaryawanServlet" method="POST">
                            ...
                            <div class="modal-body mx-3">
                                <div class="md-form mb-5">
                                    ...
                                    <input  hidden="true" readonly="true" type="text" id="orangeForm-name" class="form-control validate" name="txtkode" value="<%=karyawan%> ">
                                </div>
                                <div class="md-form mb-5">
