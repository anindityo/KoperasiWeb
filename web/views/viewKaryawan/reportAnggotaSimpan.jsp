<%-- 
    Document   : reportAnggotaSimpan
    Created on : Aug 27, 2018, 9:51:00 AM
    Author     : Gusmadika
--%>
    ...
    <body>
       <%
          try{
            ...
            File reportFile = new File(application.getRealPath("//Report//AnggotaSimpan.jasper"));//your report_name.jasper file
