<%-- 
    Document   : reportAngsuranPinjam
    Created on : Aug 27, 2018, 9:31:42 AM
    Author     : Gusmadika
--%>
    ...
    <body>
        <%
          try{
            ...
            File reportFile = new File(application.getRealPath("//Report//AngsuranPinjam.jasper"));//your report_name.jasper file
