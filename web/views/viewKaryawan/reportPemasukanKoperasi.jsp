<%-- 
    Document   : reportPemasukanKoperasi
    Created on : Aug 27, 2018, 9:36:05 AM
    Author     : Gusmadika
--%>
...
<html>
    ...
    <body><%
          try{
            ...
            File reportFile = new File(application.getRealPath("//Report//PemasukanKoperasi.jasper"));//your report_name.jasper file
