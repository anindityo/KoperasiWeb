                        ...
                        <form action="../../editAdminServlet" method="POST">
                            ...
                            <div class="modal-body mx-3">
                                <div class="md-form mb-5" >
                                  ...
                                  <input  readonly="true" type="hidden" id="orangeForm-name" class="form-control validate" name="txttgllahir" value="<%= akun.getTanggallahir() %> " >
                                ...
                                <div class="md-form mb-5" data-validate="Telepon is required">
                                    ...
                                    <input type="text" id="orangeForm-name" class="form-control validate" name="txttelepon" value="<%= akun.getTelepon() %>">
                                </div>
                                <div class="md-form mb-5" data-validate="Telepon is required">
                                ...
                                <div class="md-form mb-5" data-validate="Telepon is required">
                                    <i class="fa fa-address-book"></i>
                                    <label data-error="wrong" data-success="right" for="orangeForm-name"  >Confirm Password Baru</label>
